...
def resolve(
    data: Any,
    resolve_type: Literal[type.Type.STR],
    resolve_path: str,
) -> str | Output[str]: ...
...
def resolve(
    data: Any,
    resolve_type: Literal[type.Type.BOOL],
    resolve_path: str,
) -> bool | Output[bool]: ...
...
def resolve(
    data: Any,
    resolve_type: Literal[type.Type.INT],
    resolve_path: str,
) -> int | Output[int]: ...
...
def resolve(
    data: Any,
    resolve_type: Literal[type.Type.FLOAT],
    resolve_path: str,
) -> float | Output[float]: ...
